  ...
  if (!group) return (
    <div style={{ minHeight: "100vh", background: "var(--bg)" }}>
      ...
      <div style={{ maxWidth: 600, margin: "0 auto", padding: "calc(var(--header-h) + 60px) 16px", textAlign: "center" }}>
        ...
        <Link href="/groups" className="btn btn-secondary" style={{ gap: 6 }}><ArrowLeft size={13} />Back to Groups</Link>
      </div>
    </div>
  );
  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--bg)" }}>
      ...
      <div style={{ maxWidth: 860, margin: "0 auto", padding: "calc(var(--header-h) + 12px) 14px calc(var(--bottom-nav-h, 0px) + 40px)" }}>
        ...
        {/* Back */}
        <Link href="/groups" style={{ display: "inline-flex", alignItems: "center", gap: 5, fontSize: 12, color: "var(--text-4)", textDecoration: "none", marginBottom: 14 }}>
