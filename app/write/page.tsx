...
export default function WritePage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--bg)" }}>
      ...
      <div style={{ maxWidth: 1160, margin: "0 auto", padding: "80px 16px 80px" }}>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" }}>
            {/* Checklist progress - mobile only */}
            <div className="checklist-pill" style={{
              display: "none",
              ...
              {doneCount}/{checklist.length} ready {sidebarOpen ? <ChevronUp size={12} style={{ display: "inline" }} /> : <ChevronDown size={12} style={{ display: "inline" }} />}
            </div>
            ...
            >
              {publishing
                ? <><div className="spinner" /> {STEP_LABELS[step]}</>
                : published
        ...
        {published ? (
          <div className="card" style={{ padding: "64px 28px", textAlign: "center" }}>
            ...
            <h2 style={{ fontFamily: "Outfit, sans-serif", fontSize: "clamp(24px, 5vw, 36px)", fontWeight: 900, color: "var(--text)", marginBottom: 10 }}>
              Article Published! 🎉
            </h2>
              ...
              {!preview ? (
                <div className="card" style={{ overflow: "hidden", padding: 0 }}>
                  ...
                  <textarea
                    ...
                    style={{ minHeight: 320, padding: "20px", fontSize: 15, lineHeight: 1.8 }}
                  />
                </div>
              ) : (
            ...
            <div className="write-sidebar">
                ...
                <div style={{
                  ...
                  <input
                    ...
                    style={{
                      ...
                      fontFamily: "Outfit, sans-serif", fontSize: 26, fontWeight: 900, color: "#059669",
                    }}
                  />
              ...
              <div className="card" style={{ padding: "20px 18px" }}>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
                  ...
                  <span style={{ fontSize: 11, color: allDone ? "#059669" : "var(--text-4)", fontWeight: 700 }}>
