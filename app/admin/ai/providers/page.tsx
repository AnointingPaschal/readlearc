  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      <div>
        ...
        <p style={{ color: "var(--text-4)", fontSize: 12, marginTop: 3 }}>Admin · AI Providers</p>
      </div>
      <div className="card" style={{ padding: "48px 24px", textAlign: "center" }}>
        <Settings size={32} style={{ color: "var(--text-4)", marginBottom: 14 }} />
        <p style={{ fontSize: 15, fontWeight: 600, color: "var(--text-3)", marginBottom: 6 }}>AI Providers</p>
