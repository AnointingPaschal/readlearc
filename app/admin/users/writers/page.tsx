...
export default function WritersPage() {
  ...
  return (
    <div style={{ display:"flex", flexDirection:"column", gap:16 }}>
      ...
      {!isConnected && <div style={{ padding:"10px 14px", background:"rgba(217,119,6,.06)", border:"1px solid rgba(217,119,6,.2)", borderRadius:"var(--r)", fontSize:12, color:"#d97706", fontWeight:600 }}>Connect owner wallet to verify writers</div>}
