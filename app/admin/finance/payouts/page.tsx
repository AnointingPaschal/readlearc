...
export default function PayoutsPage() {
  const { address, isConnected, signer, shortAddress } = useWallet();
  ...
  return (
    <div style={{ display:"flex", flexDirection:"column", gap:16, maxWidth:560 }}>
      ...
      {!isConnected && <div style={{ padding:"10px 14px", background:"rgba(217,119,6,.06)", border:"1px solid rgba(217,119,6,.18)", borderRadius:"var(--r)", fontSize:12, color:"#d97706", fontWeight:600, display:"flex", gap:8 }}><AlertCircle size={14} style={{ flexShrink:0 }}/>Connect owner wallet to send USDC</div>}
