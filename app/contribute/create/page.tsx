...
export default function CreateContributeDetailPage() {
  ...
  return (
    <div style={{minHeight:"100vh",background:"var(--bg)"}}>
      ...
      <div style={{maxWidth:640,margin:"0 auto",padding:"calc(var(--header-h) + 20px) 14px calc(var(--bottom-nav-h,0px) + 40px)"}}>
        <Link href="/contribute" style={{display:"inline-flex",alignItems:"center",gap:5,fontSize:12,color:"var(--text-4)",textDecoration:"none",marginBottom:20}}><ArrowLeft size={13}/>Back to Contribute</Link>
        <h1 style={{fontFamily:"Outfit,sans-serif",fontSize:"clamp(20px,4vw,26px)",fontWeight:900,color:"var(--text)",letterSpacing:"-.02em",marginBottom:4}}>Create Space</h1>
        <p style={{fontSize:13,color:"var(--text-4)",marginBottom:24}}>Create a collaborative research space around a topic or team.</p>
        ...
        <div style={{display:"flex",flexDirection:"column",gap:14}}>
          ...
          <div className="card" style={{padding:16}}>
            <label style={lbl}>Space Type</label>
          ...
          <div className="card" style={{padding:16,display:"flex",flexDirection:"column",gap:12}}>
            ...
            <div><label style={lbl}>Description</label><textarea value={desc} onChange={e=>setDesc(e.target.value)} placeholder="What is this space about?" rows={3} style={{...inp,resize:"none",lineHeight:1.6,marginTop:6}}/></div>
          ...
          {/* Rules */}
          <div className="card" style={{padding:16}}>
            <label style={lbl}>Space Rules <span style={{fontWeight:400,color:"var(--text-4)"}}>(optional)</span></label>
